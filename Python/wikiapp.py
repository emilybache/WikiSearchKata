...
class WikiApp:
    def __init__(self, root_page):
        ...
        self.all_pages = {page.uri: page for page in DepthFirstTraverser(root_page).traverse()}
        
    def handle_request(self, request):
        responder = responder_for(request)
        return responder.make_response(request, RequestContext(self.root_page, self.all_pages))
